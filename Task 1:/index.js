...
class SupermarketSimulator {
    ...
    static buyGroceries() {
        ...
        const choice = "fruits"; // Change to "vegetables" for testing vegetables scenario
        if (choice === "fruits") {
    ...
    static applyDiscount(totalBill) {
    ...
    static checkoutProcess() {
        ...
        let paymentMethod = "Credit Card"; // Change for testing different payment methods
